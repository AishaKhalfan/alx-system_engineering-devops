...
Example:
```
khalfan@ubuntu$ python3 0-gather_data_from_an_API.py 2
...
khalfan@ubuntu$ python3 0-gather_data_from_an_API.py 4
...
khalfan@ubuntu$
khalfan@ubuntu$ python3 0-gather_data_from_an_API.py 4 | tr " " "S" | tr "\t" "T" 
...
Example:
```
khalfan@ubuntu$ python3 1-export_to_CSV.py 2
khalfan@ubuntu$ cat 2.csv
...
```
khalfan@ubuntu$ python3 2-export_to_JSON.py 2
khalfan@ubuntu$ cat 2.json
{"2": [{"task": "suscipit repellat esse quibusdam voluptatem incidunt", "completed": false, "username": "Antonette"},
 ...
 {"task": "aliquam aut quasi", "completed": true, "username": "Antonette"}, {"task": "veritatis pariatur delectus", "completed": true, "username": "Antonette"},
...
{"task": "excepturi deleniti adipisci voluptatem et neque optio illum ad", "completed": true, "username": "Antonette"},
 {"task": "sunt cum tempora", "completed": false, "username": "Antonette"}, {"task": "totam quia non", "completed": false, "username": "Antonette"},
...
{"1": [{"username": "Bret", "task": "delectus aut autem", "completed": false}, {"username": "Bret", "task": "quis ut nam facilis et officia qui", "completed": false}, {"username": "Bret", "task": "fugiat veniam minus", "completed": false},
 ...
 {"username": "Moriah.Stanton", "task": "numquam repellendus a magnam", "completed": true}, {"username": "Moriah.Stanton", "task": "ipsam aperiam voluptates qui", "completed": false}]}
khalfan@ubuntu$
```
Repo:

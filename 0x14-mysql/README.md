...
## - [Web stack debugging](https://github.com/AishaKhalfan/alx-system_engineering-devops/blob/master/0x0D-web_stack_debugging_0/README.md)
...
```
![alt text](https://github.com/AishaKhalfan/alx-system_engineering-devops/blob/master/0x14-mysql/mysql.png)
